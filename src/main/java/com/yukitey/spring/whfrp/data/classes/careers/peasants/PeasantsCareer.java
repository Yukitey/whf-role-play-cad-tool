package com.yukitey.spring.whfrp.data.classes.careers.peasants;
...
/**
 * Careers available to peasants class.
 * @author Andrey Sadovinskiy
 */
public enum PeasantsCareer implements CharacterClassCareer {
    ...
    PeasantsCareer(@NonNull final String id, @NonNull final Class<? extends Career> career) {
        this.id = id;
        this.career = career;
    }
