package com.yukitey.spring.whfrp.data.classes.careers.rangers;
...
/**
 * Careers available to rangers class.
 * @author Andrey Sadovinskiy
 */
public enum RangersCareer implements CharacterClassCareer {
    ...
    RangersCareer(@NonNull final String id, @NonNull final Class<? extends Career> career) {
        this.id = id;
        this.career = career;
    }
