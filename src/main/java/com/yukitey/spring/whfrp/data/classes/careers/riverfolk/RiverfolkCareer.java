package com.yukitey.spring.whfrp.data.classes.careers.riverfolk;
...
/**
 * Careers available to riverfolk class.
 * @author Andrey Sadovinskiy
 */
public enum RiverfolkCareer implements CharacterClassCareer {
    ...
    RiverfolkCareer(@NonNull final String id, @NonNull final Class<? extends Career> career) {
        this.id = id;
        this.career = career;
    }
