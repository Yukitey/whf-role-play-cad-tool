package com.yukitey.spring.whfrp.data.classes.careers.courtiers;
...
/**
 * Careers available to courtiers class.
 * @author Andrey Sadovinskiy
 */
public enum CourtiersCareer implements CharacterClassCareer {
    ...
    CourtiersCareer(@NonNull final String id, @NonNull final Class<? extends Career> career) {
        this.id = id;
        this.career = career;
    }
