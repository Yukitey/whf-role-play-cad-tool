package com.yukitey.spring.whfrp.data.classes.careers.rogues;
...
/**
 * Careers available to rogues class.
 * @author Andrey Sadovinskiy
 */
public enum RoguesCareer implements CharacterClassCareer {
    ...
    RoguesCareer(@NonNull final String id, @NonNull final Class<? extends Career> career) {
        this.id = id;
        this.career = career;
    }
